...
def add_population_density(cleaned_data_file):
    """
    Add population density information to the cleaned data.
    ...
    # Refniscodes are split into even smaller sections -> merge them to overcome issues (take into account in interpretations)
    ...
    # Importing cleaned data into a DataFrame
    ...
    # Adding a new column for population density in original DataFrame, based on the mapping
