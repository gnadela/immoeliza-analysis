...
def clean_data(raw_data):
    ...
    7. Replace the symbol '�' with 'e' in all string columns.
    8. Remove leading and trailing spaces from string columns.
    9. Write resulting dataframe to a CSV file.
